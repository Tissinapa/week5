...
!function (t, e) {
  ...
  function M(t, e) {
    var i;
    if (void 0 !== t.classList) for (var n = U(e), o = 0, s = n.length; o < s; o++) {
      t.classList.add(n[o]);
  ...
  he = "onselectstart" in document ? (ae = function ae() {
    S(window, "selectstart", k);
  }, function () {
    E(window, "selectstart", k);
  }) : (re = be(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]), ae = function ae() {
    var t;
  ...
  function S(t, e, i, n) {
    if (e && "object" == _typeof(e)) for (var o in e) {
      Be(t, o, e[o], i);
    } else for (var s = 0, r = (e = U(e)).length; s < r; s++) {
      Be(t, e[s], i, n);
    }
    return this;
  }
  ...
  function E(t, e, i, n) {
    if (1 === arguments.length) ke(t), delete t[Ee];else if (e && "object" == _typeof(e)) for (var o in e) {
      Ae(t, o, e[o], i);
  ...
  function Be(e, t, i, n) {
    ...
    e[Ee] && e[Ee][r] || (s = o = function o(t) {
      ...
      passive: !1
    }) : "mouseenter" === t || "mouseleave" === t ? e.addEventListener(Oe[t], o = function o(t) {
  ...
  var Ke,
    ...
    onAdd: function onAdd(t) {
      for (var e in (t.attributionControl = this)._container = P("div", "leaflet-control-attribution"), Ne(this._container), t._layers) {
  ...
  var Zi = zi.extend({
    ...
    _clipPoints: function _clipPoints() {
      ...
      if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) if (this.options.noClip) this._parts = this._rings;else for (var i, n = 0, o = this._rings.length; n < o; n++) {
        (i = li(this._rings[n], t, !0)).length && this._parts.push(i);
      }
    },
    _updatePath: function _updatePath() {
  ...
  function Ai(t, e, i) {
    for (var n, o = [], s = 0, r = t.length; s < r; s++) {
      n = e ? Ai(t[s], e - 1, i) : (i || Bi)(t[s]), o.push(n);
    }
  ...
  function Ri(t, e, i, n) {
    for (var o = [], s = 0, r = t.length; s < r; s++) {
      o.push(e ? Ri(t[s], A(t[s]) ? 0 : e - 1, i, n) : Ii(t[s], n));
    }
  ...
  var en = Qi.extend({
    ...
    _abortLoading: function _abortLoading() {
      ...
      for (t in this._tiles) {
        this._tiles[t].coords.z !== this._tileZoom && ((i = this._tiles[t].el).onload = u, i.onerror = u, i.complete || (i.src = Y, e = this._tiles[t].coords, T(i), delete this._tiles[t], this.fire("tileabort", {
          tile: i,
          coords: e
        })));
      }
